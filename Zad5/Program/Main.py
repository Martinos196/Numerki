from funkcje import wartosc_funkcji, wzor_funkcji,gauss_blad, wsp_wielomian, wart_wielomian
import numpy as np
import pylab as pb
import wielomian
...
menu = True
while menu:
    print("Witaj w programie obliczajacym aproksymacje wybranych funkcji na przedziale <-1:1>")
